...
if (url.searchParams.get('by') != null) {
  ...
  sender = "Abraham Benedick";
}


document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Pacarku", "Aku ada pertanyaan nih buat kamu yang", "question").then(function () {
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen ${nama} , makasihhh yaa`).then(function () {
                          Swal.fire('Terakhir deh nih sayang').then(function () {
